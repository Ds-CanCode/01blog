...
export const routes: Routes = [
    ...
    { path: 'home', loadComponent: () => import('./components/home/home.component').then(m => m.HomeComponent)},
     { path: 'papier', loadComponent: () => import('./components/papier/papier.component').then(m => m.PapierComponent)},
    { path: 'article/:id', loadComponent: () => import('./components/article/article.component').then(m => m.ArticleComponent)},
